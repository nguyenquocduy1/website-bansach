...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12" style="margin-left: 80px; padding-right:70px">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">THÊM TÁC GIẢ</h3>
                </div>
                <div class="col-12" style="padding-top:10px;">
                    <ul class="breadcrumb" style="border: none">
                      <li><a href="{{route('dashboard.index')}}">Dashboard</a></li><li>/</li>
                      <li><a href="{{route('tacgia.index')}}">Quản tác giả</a></li><li>/</li>
                      <li>Thêm tác giả</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <!-- form start -->
                <form action=" {{route('tacgia.store')}} " method="POST" enctype="multipart/form-data" onsubmit="return CheckInput();">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                    <label for="exampleInputTitle">Tên Tác Giả</label>
                    <input class="form-control" type="text" name="tentacgia" id="tentacgia" placeholder="Tên tác giả">
                  </div>
