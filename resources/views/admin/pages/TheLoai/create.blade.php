...
<div class="main-panel">
    <div class="content-wrapper">
            ...
            <div class="col-md-12" style="margin-left: 80px; padding-right:70px">
                ...
                <div class="col-12" style="padding-top:10px;">
                    <ul class="breadcrumb" style="border: none">
                      ...
                      <li><a href="{{route('theloai.index')}}">Quản lý thể loại</a></li><li>/</li>
                      <li>Thêm thể loại</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <!-- form start -->
                <form action=" {{route('theloai.store')}} " method="POST" enctype="multipart/form-data" onsubmit="return CheckInput();">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
