...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12" style="margin-left: 80px; padding-right:70px">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Sửa Nhà Xuất Bản</h3>
                </div>
        ...
        <div class="container">
            <!-- form start -->
                <form action=" {{ route('nhaxuatban.update', $nhaxuatban->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return CheckInput();">
                {{ csrf_field() }}
    @csrf
            @method('PUT')
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <input class="form-control" type="text" name="tennhaxb" value="{{$nhaxuatban->tennhaxb}}" id="tennhaxb" placeholder="Tên nhà cung cấp">
                  </div>
